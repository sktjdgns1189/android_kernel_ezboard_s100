...
#ifdef CONFIG_FALINUX_ZEROBOOT_NAL
// u32 (* zero_zap_pte_range_hock)( struct task_struct * tsk  ) = NULL;
// EXPORT_SYMBOL(zero_zap_pte_range_hock);
...
//} nalcode_head_t;
//
//#define NALCODE_VADDRESS                              0xFFFF8000
...
//          volatile u32    data;
//
//          paddr = MMU_L2_PADDR_SMALL(entry);
//          vaddr = (u32 *) ( phys_to_virt( paddr ) );
//          data = *vaddr;
//          printk( ">> NALCODE LOAD PADRR = %08X VADDR= %08X DATA = %08X\n", paddr, (int) vad
//      }
//  }
#endif
		set_pte_at(mm, address, page_table, entry);
