...
void __init reserve_node_zero(pg_data_t *pgdat)
{
   ...
   if(machine_is_ezs5pv210() || machine_is_ezs3c6410()) {
       reserve_bootmem_node(pgdat, PHYS_OFFSET + 0x00008000, 0x00080000, BOOTMEM_DEFAULT);
       reserve_bootmem_node(pgdat, PHYS_OFFSET + 0x00088000, 0x00008000, BOOTMEM_DEFAULT);
   #ifdef CONFIG_FALINUX_ZEROBOOT_NAL_PREBOOT
       reserve_bootmem_node(pgdat, PHYS_OFFSET + 0x00090000, 0x00008000, BOOTMEM_DEFAULT);
   #endif
   }
#endif
