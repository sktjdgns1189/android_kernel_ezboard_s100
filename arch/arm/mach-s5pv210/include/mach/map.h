...
#define S5PV210_PA_CS0     (0x80000000)
#define S5PV210_PA_CS1     (0x88000000)
#define S5PV210_PA_CS2     (0x90000000)
#define S5PV210_PA_CS3     (0x98000000)
#define S5PV210_PA_CS4     (0xA0000000)
#define S5PV210_PA_CS5     (0xA8000000)
...
#elif defined(CONFIG_MACH_EZS5PV210)
#include <mach/memory.h>
#define S5PV210_PA_SDRAM	PHYS_OFFSET
#else
