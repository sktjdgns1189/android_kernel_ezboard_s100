...
unsigned int mfc_local_test_shared_mem_vaddr = 0;
...
static enum mfc_error_code mfc_alloc_codec_buffer(struct mfc_inst_ctx *mfc_ctx, union mfc_args *args)
{
	...
	mfc_debug_L0("====> mfc_ctx->shared_mem_vaddr:%X (unsigned int)mfc_get_fw_buff_vaddr():%X\n====> mfc_ctx->shared_mem_paddr:%X, mfc_port0_base_paddr:%X\n",
mfc_ctx->shared_mem_vaddr, (unsigned int)mfc_get_fw_buff_vaddr() , mfc_ctx->shared_mem_paddr, mfc_port0_base_paddr);
mfc_local_test_shared_mem_vaddr =  mfc_ctx->shared_mem_vaddr;
...
enum mfc_error_code mfc_init_decode(struct mfc_inst_ctx *mfc_ctx, union mfc_args *args)
{
	...
	if ( mfc_local_test_shared_mem_vaddr !=  0 )
		mfc_ctx->shared_mem_vaddr = mfc_local_test_shared_mem_vaddr;
