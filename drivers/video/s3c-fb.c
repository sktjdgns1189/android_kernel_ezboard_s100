				      	...
				      	struct s3c_fb_win **res)
{
   ...
   dev_info(sfb->dev, "window %d: fb %s ( %dx%d )\n", win_no, fbinfo->fix.id, fbinfo->var.xres, fbinfo->var.yres);
#else
